...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center grid-bg scanline overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 mt-16 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        {/* Text */}
        <div className="order-2 lg:order-1 text-center lg:text-left">
          ...
          <div className="flex flex-wrap gap-6 mb-8 justify-center lg:justify-start">
            {[
              ...
              <div key={s.label} className="text-center border border-primary/30 rounded-lg px-5 py-3 neon-border">
